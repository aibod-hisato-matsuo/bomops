...
export type PartMasterProductSummary = Schemas['PartMasterProductSummary']
...
export type ProductModelHierarchySummary = Schemas['ProductModelHierarchySummary']
export type ProductBOM = Schemas['ProductBOM']
export type SoftwareMaster = Schemas['SoftwareMaster']
...
export type BssSetLocationSummary = Schemas['BssSetLocationSummary']
